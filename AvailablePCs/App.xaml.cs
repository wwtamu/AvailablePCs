    ...
    sealed partial class App : Application
    {
        ...
        protected async override void OnLaunched(LaunchActivatedEventArgs args)
        {
            ...
            if (rootFrame == null)
            {
                ...
                AvailablePCs.SuspensionManager.RegisterFrame(rootFrame, "AvailablePCsFrame");
                if (args.PreviousExecutionState == ApplicationExecutionState.Terminated)
                {
                    //TODO: Load state from previously suspended application
                    try
                    {
                        await AvailablePCs.SuspensionManager.RestoreAsync();
                    }
                    catch (Exception) { }
                }
        ...
        {
            SettingsCommand cmd =
                new SettingsCommand("cache-options", "Cache Options",
                (x) =>
                {
                    ...
                    settings.Content = _sv;
                    settings.IsOpen = true;
                    AvailablePCs.SettingsView.SetCacheSetting(AvailablePCs.SettingsView.GetCacheSetting());
                });
        ...
        private async void OnSuspending(object sender, SuspendingEventArgs e)
        {
            ...
            try
            {
                await AvailablePCs.SuspensionManager.SaveAsync();
            }
            catch (Exception) { }
            deferral.Complete();
        }
